...
1. Indica:
   ...
   * Nombre de la entidad sancionada.
   * Tipo de organización (empresa privada, administración pública, autónomo…).
   * Importe de la sanción.
   * Artículo del RGPD o LOPDGDD vulnerado.

2. Explica:

   * ¿Qué hizo mal la organización?
   * ¿Qué datos personales estaban implicados?
   * ¿Cómo podría haberse evitado la sanción?
...
* Propuesta de medidas preventivas (2 puntos)
* Reflexión crítica argumentada (2 puntos)
...
* Fotografías de alumnos en actividades escolares.
* Listados con nombre y apellidos de estudiantes premiados.
...
3. ¿Qué información debe incluir el formulario de contacto?
4. ¿Se está incumpliendo la LSSI-CE? ¿Por qué?
5. ¿Qué medidas correctivas propondrías?
...
1. ¿Tiene política de privacidad visible?
2. ¿Existe aviso de cookies?
3. ¿Permite aceptar/rechazar cookies?
...
* ¿Debe informar a los afectados?
* ¿Debe comunicarlo a la AEPD?
* ¿En cuánto tiempo?
